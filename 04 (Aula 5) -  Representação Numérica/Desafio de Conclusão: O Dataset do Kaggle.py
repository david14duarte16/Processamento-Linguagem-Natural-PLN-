...
# =========================================
# 2. CARREGAR DATASET (OLIST)
# =========================================
df = pd.read_csv("olist_order_reviews_dataset.csv", nrows=5000)

print("Primeiras linhas do dataset:")
print(df.head())

# =========================================
# 3. DEFINIR COLUNA DE TEXTO
# =========================================
...
try:
    ...
    print("\n⚠️ Não foi possível converter para denso (memória insuficiente)")
    memoria_densa = None
    erro_memoria = True
